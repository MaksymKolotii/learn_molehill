package {
	...
	public class Main extends Sprite {
		...
		[Embed(source='../assets/level_key.png')]
		private static const LEVELKEYDATA:Class;
		private var levelKey:Bitmap = new LEVELKEYDATA();

		[Embed(source='../assets/level_00.png')]
		private static const LEVELDATA:Class;
		private var levelData:Bitmap = new LEVELDATA();

		[Embed(source='../assets/gui_font.ttf', embedAsCFF='false', fontFamily='guiFont', mimeType='application/x-font-truetype',
				unicodeRange='U+0020-U+002F, U+0030-U+0039, U+003A-U+0040, U+0041-U+005A, U+005B-U+0060, U+0061-U+007A, U+007B-U+007E')]
		private const GUI_FONT:Class;

		[Embed(source="../assets/sounds/sfxmusic.mp3")]
		public var introMp3:Class;

		[Embed(source="../assets/sounds/sfxblast.mp3")]
		public var blastMp3:Class;

		[Embed(source="../assets/sounds/sfxexplode.mp3")]
		public var explodeMp3:Class;

		[Embed(source="../assets/sounds/sfxgun.mp3")]
...
// this error is fired if the swf is not using wmode=direct
		...
		private function initParticleModels():void {
			...
			particleSystem.defineParticle("explosion", new Stage3dParticle(explosion1_data, context3D, puffTexture, explosionfat_data));
			particleSystem.defineParticle("bluebolt", new Stage3dParticle(explosion1_data, context3D, particle1texture, explosion2_data));
			particleSystem.defineParticle("greenpuff", new Stage3dParticle(explosion1_data, context3D, particle2texture, explosion2_data));
			particleSystem.defineParticle("ringfire", new Stage3dParticle(explosion1_data, context3D, particle3texture, explosion2_data));
			particleSystem.defineParticle("sparks", new Stage3dParticle(explosion1_data, context3D, particle4texture, explosion2_data));
			// debris from destroyed asteroids
			var party:Stage3dParticle;
			party = new Stage3dParticle(asteroid_00_data, context3D, cratersTexture);
