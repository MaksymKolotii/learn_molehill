package {
	...
	public class Stage3dObjParser {
		...
		public function Stage3dObjParser(objfile:Class, acontext:Context3D, scale:Number = 1, dataIsZxy:Boolean = false, textureFlip:Boolean = false) {
...
// Check first word and delegate remainder to proper parser.
		...
		public function restoreNormals():void { // utility function
			_rawNormalsBuffer = _cachedRawNormalsBuffer.concat();
		}

		public function get3PointNormal(p0:Vector3D, p1:Vector3D, p2:Vector3D):Vector3D { // utility function
		...
		public function forceNormals():void { // utility function
