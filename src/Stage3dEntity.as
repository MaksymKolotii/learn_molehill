package {
	...
	public class Stage3dEntity {
		...
		// Class Constructor
		public function Stage3dEntity(mydata:Class = null, mycontext:Context3D = null, myshader:Program3D = null, mytexture:Texture = null, modelscale:Number = 1, flipAxis:Boolean = true, flipTexture:Boolean = true) {
...
// move according to the direction we are facing
		...
		public function render(view:Matrix3D, projection:Matrix3D, statechanged:Boolean = true):void {
			...
			if (statechanged) {// Set the AGAL program
